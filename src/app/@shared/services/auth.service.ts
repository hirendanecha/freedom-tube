...
export class AuthService {
    ...
    constructor(
        ...
        const userJson = this.cookieService.get('auth-user') == '.opash.in' ? JSON.parse(this.cookieService.get('auth-user')) : {};
        this.user = new BehaviorSubject<any>(userJson);
        this.token = new BehaviorSubject<any>(this.cookieService.get('token') == '.opash.in' ? this.cookieService.get('token') : '');
    }
